...
public class State implements AutoCloseable {
  public static final Identifier TEXTURE_ID = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "image_editor");
  ...
  public State(@NotNull PackData.Painting painting) {
    ...
    this.subscriptions.add(this.operations.subscribe((operations) -> {
